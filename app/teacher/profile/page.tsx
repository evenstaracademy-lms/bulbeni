  ...
  return <DashboardShell nav={teacherNav} role="Teacher" initials={initials} hideBottomSettings>
    ...
    <div className="profile-layout legacy-profile-layout">
      ...
      <aside className="profile-side-column">
        <Section icon={School} title="Teaching Preferences"><dl className="facts-list"><div><dt>School types</dt><dd>{profile.schoolTypes?.split("|").join(", ")||"Pending"}</dd></div><div><dt>Contract</dt><dd>{profile.employment?.split("|").join(", ")||"Pending"}</dd></div><div><dt>Open to relocation</dt><dd>{profile.relocation||"Pending"}</dd></div></dl></Section>
